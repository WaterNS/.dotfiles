...
if [ ! -d "$HOME/.dotfiles/opt/ohmyzsh-custom/themes/powerlevel10k" ]; then
  ...
  echo ""
elif [ "$u" = true  ]; then updateGitRepo "Powerlevel10k" "OhMyZSH theme" ~/.dotfiles/opt/ohmyzsh-custom/themes/powerlevel10k --depth 1;
fi
...
if [ ! -d "$HOME/.dotfiles/opt/zsh-extras/zsh-autosuggestions" ]; then
  ...
  echo ""
elif [ "$u" = true  ]; then updateGitRepo "ZSH Auto Suggestions" "ZSH extra" ~/.dotfiles/opt/zsh-extras/zsh-autosuggestions --depth 1;
fi
...
if [ ! -d "$HOME/.dotfiles/opt/zsh-extras/zsh-syntax-highlighting" ]; then
  ...
  echo ""
elif [ "$u" = true  ]; then updateGitRepo "ZSH Syntax Highlighting" "ZSH extra" ~/.dotfiles/opt/zsh-extras/zsh-syntax-highlighting --depth 1;
fi
